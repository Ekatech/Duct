...
const messages = defineMessages({
  welcome: {
    id: 'services.welcome',
    defaultMessage: '!!!Welcome to Duct',
  },
  getStarted: {
  ...
  login: {
    id: 'services.login',
    defaultMessage: '!!!Please login to use Duct.',
  },
  serverless: {
    id: 'services.serverless',
    defaultMessage: '!!!Use Duct without an Account',
  },
  serverInfo: {
    id: 'services.serverInfo',
    defaultMessage: '!!!Optionally, you can change your Duct server by clicking the cog in the bottom left corner.',
  },
});
