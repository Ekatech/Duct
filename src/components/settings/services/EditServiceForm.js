...
const messages = defineMessages({
  ...
  customUrlPremiumInfo: {
    ...
    defaultMessage: '!!!To add self hosted services, you need a Duct Premium Supporter Account.',
  },
  ...
  proxyRestartInfo: {
    ...
    defaultMessage: '!!!Please restart Duct after changing proxy Settings.',
  },
  proxyInfo: {
    id: 'settings.service.form.proxy.info',
    defaultMessage: '!!!Proxy settings will not be synchronized with the Duct servers.',
  },
});
