...
const messages = defineMessages({
  ...
  deleteInfo: {
    ...
    defaultMessage:
      "!!!If you don't need your Duct account any longer, you can delete your account and all related data here.",
  },
  deleteEmailSent: {
  ...
  accountUnavailableInfo: {
    ...
    defaultMessage: 'You are using Duct without an account. If you want to use Duct with an account and keep your services synchronized across installations, please select a server in the Settings tab then login.',
  },
});
