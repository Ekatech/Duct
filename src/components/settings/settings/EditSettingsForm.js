...
const messages = defineMessages({
  ...
  sentryInfo: {
    ...
    defaultMessage: '!!!Sending telemetry data allows us to find errors in Duct - we will not send any personal information like your message data! Changing this option requires you to restart Duct.',
  },
  hibernateInfo: {
    id: 'settings.app.hibernateInfo',
    defaultMessage: '!!!By default, Duct will keep all your services open and loaded in the background so they are ready when you want to use them. Service Hibernation will unload your services after a specified amount. This is useful to save RAM or keeping services from slowing down your computer.',
  },
  inactivityLockInfo: {
    id: 'settings.app.inactivityLockInfo',
    defaultMessage: '!!!Minutes of inactivity, after which Duct should automatically lock. Use 0 to disable',
  },
  todoServerInfo: {
  ...
  lockedPasswordInfo: {
    ...
    defaultMessage: '!!!Please make sure to set a password you\'ll remember.\nIf you loose this password, you will have to reinstall Duct.',
  },
  lockInfo: {
    id: 'settings.app.lockInfo',
    defaultMessage: '!!!Password Lock allows you to keep your messages protected.\nUsing Password Lock, you will be prompted to enter your password everytime you start Duct or lock Duct yourself using the lock symbol in the bottom left corner or the shortcut CMD/CTRL+Shift+L.',
  },
  ...
  scheduledDNDInfo: {
    ...
    defaultMessage: '!!!Scheduled Do-not-Disturb allows you to define a period of time in which you do not want to get Notifications from Duct.',
  },
  headlineLanguage: {
  ...
  translationHelp: {
    ...
    defaultMessage: '!!!Help us to translate Duct into your language.',
  },
  spellCheckerLanguageInfo: {
    id: 'settings.app.spellCheckerLanguageInfo',
    defaultMessage: '!!!Duct uses your Mac\'s build-in spellchecker to check for typos. If you want to change the languages the spellchecker checks for, you can do so in your Mac\'s System Preferences.',
  },
  subheadlineCache: {
  ...
  cacheInfo: {
    ...
    defaultMessage: '!!!Duct cache is currently using {size} of disk space.',
  },
  cacheNotCleared: {
  ...
  updateStatusUpToDate: {
    ...
    defaultMessage: '!!!You are using the latest version of Duct',
  },
  currentVersion: {
