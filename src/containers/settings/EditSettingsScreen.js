...
const messages = defineMessages({
  autoLaunchOnStart: {
    ...
    defaultMessage: '!!!Launch Duct on start',
  },
  ...
  runInBackground: {
    ...
    defaultMessage: '!!!Keep Duct in background when closing the window',
  },
  startMinimized: {
  ...
  enableSystemTray: {
    ...
    defaultMessage: '!!!Always show Duct in system tray',
  },
  reloadAfterResume: {
    id: 'settings.app.form.reloadAfterResume',
    defaultMessage: '!!!Reload Duct after system resume',
  },
  minimizeToSystemTray: {
    id: 'settings.app.form.minimizeToSystemTray',
    defaultMessage: '!!!Minimize Duct to system tray',
  },
  closeToSystemTray: {
    id: 'settings.app.form.closeToSystemTray',
    defaultMessage: '!!!Close Duct to system tray',
  },
