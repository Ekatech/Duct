...
storiesOf('Infobox')
  ...
  .add('With long text', () => (
    ...
    >
      Duct is your messaging app / former Emperor of Austria and combines chat & messaging services into one application. Duct currently supports Slack, WhatsApp, WeChat, HipChat, Facebook Messenger, Telegram, Google Hangouts,GroupMe, Skype and many more.
    </WithStoreInfobox>
  ))
  .add('Secondary', () => (
    <WithStoreInfobox
